...
await env.withSecurityRulesDisabled(async (context) => {
  ...
  await setDoc(
    doc(db, "progressionProfiles", "bob"),
    profile("bob", { xp: 26000, lifetimeXp: 28000, seasonXp: 9000, coin: 2200 }),
  );
...
await assertFails(
  updateDoc(doc(alice, "progressionProfiles", "alice"), {
    coin: 999999,
...
await assertFails(
  setDoc(doc(alice, "progressionLedger", "spend_alice_title-night-rider"), {
    uid: "alice",
    sourceType: "vault_spend",
...
const meetRewardTx = async (db, nonce) =>
...
await assertSucceeds(
  setDoc(doc(alice, "progressionAchievementClaims", "alice_first-blood"), {
    uid: "alice",
...
await assertFails(
  setDoc(doc(alice, "progressionAchievementClaims", "alice_legend"), {
    uid: "alice",
...
if (
  bobAfter.data().prestige !== 1 ||
  bobAfter.data().xp !== 0 ||
  bobAfter.data().coin !== 2200 ||
  bobAfter.data().lifetimeXp !== 28000 ||
  bobAfter.data().seasonXp !== 9000
) {
