  ...
  return (
    <section className="oni-command" aria-labelledby="oni-hero-title">
      <div className="oni-command__city" aria-hidden="true" style={{ inset: 0 }}>
        <video autoPlay loop muted playsInline preload="metadata" poster={cityBg} disablePictureInPicture tabIndex={-1} style={{ width: "100%", height: "100%", objectFit: "cover", objectPosition: "center" }}>
          <source src={HERO_VIDEO} type="video/quicktime" />
        </video>
      </div>
      <div aria-hidden="true" style={{ position: "absolute", zIndex: 1, inset: 0, pointerEvents: "none", background: "linear-gradient(90deg, rgba(4,4,10,.9) 0%, rgba(4,4,10,.58) 30%, rgba(4,4,10,.08) 63%, rgba(4,4,10,.2) 100%), linear-gradient(0deg, rgba(4,4,10,.92) 0%, transparent 44%)" }} />
      ...
      <div className="oni-command__ui">
        ...
        <aside className="oni-command__chapter" aria-label="ОНИ хотын бүлэг"><span>CHAPTER</span><strong>00</strong><small>THE CITY<br />AWAKENS</small></aside>
